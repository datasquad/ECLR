...
To copy this into your VLE, open [this](docs/BB_text.txt) and copy (CTRL+C) the text contained therein. Then go to your VLE and create a new item wherever you want to add this information. In Blackboard you will have to switch to HTML mode
