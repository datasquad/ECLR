...
This walkthrough is part of the [ECLR](https://datasquad.github.io/ECLR/) page. A video walkthrough is available from [YouTube, 32 min](https://youtu.be/0GmYu4SKmSo).
...
As there are so many LSOAs the above file is rather big. We have selected the LSOAs which we want to use below (using data on ) and saved these in the `NEcities.lsoa` object which you can load from [the ECLR page](https://github.com/datasquad/ECLR/blob/gh-pages/data/NEcities_lsoa.RData). Place that file in your working directory.
