...
As there are so many LSOAs the above file is rather big. We have selected the LSOAs which we want to use below (using data on ) and saved these in the `NEcities.lsoa` object which you can load from [here](https://github.com/datasquad/ECLR/blob/gh-pages/data/NEcities_lsoa.RData). Place that file in your working directory.
