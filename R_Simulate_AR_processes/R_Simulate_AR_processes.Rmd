...
Note that `list(ar = c(0.8), ma = c())` set's and AR(1) model parameter of $gamma_1=0.8$. There is provision for also allowing for moving average processes, but we leave that empty (`ma = c()`) as we are not using MA components here.
