...
We will also use two functions saved in .r files. The function of these two files will be explained below. These are available for download from here: [stargazer_HC.R](https://github.com/datasquad/ECLR/blob/gh-pages/docs/stargazer_HC.R) and [stargazer_HAC.R](https://github.com/datasquad/ECLR/blob/gh-pages/docs/stargazer_HAC.R).
