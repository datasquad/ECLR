...
For each of these a LASSO is applied to select variables from \mathbf{x}_i. The two selections will typicaly be different and the Post Double Selection estimator then uses the union of these two selections, \mathbf{x}^*_i, in a new model.
