...
| Topic | Workthrough | Data used |
|:------|:-----|:-----|
| Basic regression models | Workthrough: [R](https://datasquad.github.io/ECLR/R_RegressionIntro.html) | [WBdata.Rdata](https://github.com/datasquad/ECLR/blob/gh-pages/data/WBdata.Rdata) 

## Dealing with Time-Series variables

| Topic | Workthrough | Data used |
|:------|:-----|:-----|
| Basic TS modeling | Workthrough: [R](https://datasquad.github.io/ECLR/R_TS_Modelling.html) | [EUROSTATtimeseries.csv](https://github.com/datasquad/ECLR/blob/gh-pages/data/EUROSTATtimeseries.csv) 
