...
author:  "[Ralf Becker](https://www.socialsciences.manchester.ac.uk/economics/) at [The University of Manchester](http://www.manchester.ac.uk)"
date: "`r Sys.Date()`"
output:
  html_document:
    fig_width: 1
...
In the following a few basic data techniques are introduced

| Topic | Workthrough | Data used |
|:------|:-----|:-----|
| First Steps | Workthrough: [R](https://datasquad.github.io/ECLR/R_FirstSteps.html) | [STATS19_GM_AccData.csv](https://datasquad.github.io/ECLR/Data/STATS19_GM_AccData.csv)
| Loading Data | Workthrough: [R](https://datasquad.github.io/ECLR/R_DataDownload.html) | [mroz.csv](https://github.com/datasquad/ECLR/raw/gh-pages/data/Mroz.csv), [mroz.xlsx](https://github.com/datasquad/ECLR/raw/gh-pages/data/Mroz.xlsx)
| Basic Data Analysis | Workthrough: [R](https://datasquad.github.io/ECLR/R_BasicDataAnalysis.html) | [mroz.csv](https://github.com/datasquad/ECLR/raw/gh-pages/data/mroz.csv) 
| Basic Data Analysis (Tidyverse) | Workthrough: [R](https://datasquad.github.io/ECLR/R_SummaryStatsTidyverse.html) | [mlb1.csv](https://github.com/datasquad/ECLR/raw/gh-pages/data/mlb1.csv) 
...
| Topic | Workthrough | Data used |
|:------|:-----|:-----|
| Basic Data Visualisation (ggplot) | Workthrough: [R](https://datasquad.github.io/ECLR/R_GraphIntro.html) | [mlb1.csv](https://github.com/datasquad/ECLR/raw/gh-pages/data/mlb1.csv) 
