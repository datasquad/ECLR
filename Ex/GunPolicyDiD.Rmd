...
In the last step of Part 1 we saved all data in a well formatted datafile "US Gun_example_v3.csv", [https://raw.githubusercontent.com/datasquad/ECLR/gh-pages/data/US%20Gun_example_v3.csv](which you can download from here) such that you can then load it:
