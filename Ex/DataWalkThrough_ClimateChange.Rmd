...
Once the readxl library is activated, we can use its `read_excel()` function to import the ["natural.xlsx"](https://raw.githubusercontent.com/datasquad/ECLR/refs/heads/gh-pages/data/natural.xlsx) dataset. We then store the imported dataset in an object named `emdat`.
...
When you download this you will get a zip file and you should extract the contents of the zip file into your working directory. One of the files is an EXCEL file called ["EDGAR_AR5_GHG_1970_2023.xlsx"](https://raw.githubusercontent.com/datasquad/ECLR/refs/heads/gh-pages/data/EDGAR_AR5_GHG_1970_2023.xlsx). Let us load this file.
...
Annual population data are available from various sources. The ["WorldBank_population.csv"](https://github.com/datasquad/ECLR/raw/refs/heads/gh-pages/data/WorldBank_population.csv) file contains such data, from the World Bank. Let's import these.
