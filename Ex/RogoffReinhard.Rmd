...
```{r}
# RRData <- read_excel("C:/Rcode/ECLR/data/RRdata.xlsx")
RRData <- read_excel("data/RRdata.xlsx")
...
Let's start by testing a hypothesis on the sample mean of the GDP growth rate (`dRGDP`) Let's say we want to test the hypothesis that the mean growth rate is 3.3% (note that 3.3% in the data is represented as 3.3). Let's get one calculated and then diiscuss what we really did:
