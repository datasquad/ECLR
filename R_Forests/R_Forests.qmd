...
There are slight differences in ranking of variables across the plots, but they are generally in agreement with one another, and with the tree we fit earlier. Note, there could be negative scores. The actual scores can be obtained by typing the following:
