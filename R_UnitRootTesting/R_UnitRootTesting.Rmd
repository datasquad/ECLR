...
`r hide("How should I know how to restrict the sample?")`
...
One quick way to find out is to search for "R xts cheatsheet". You are likely to find [this cheatsheet](https://www.datacamp.com/cheat-sheet/xts-cheat-sheet-time-series-in-r) and on there you can find out how to restrict the sample for subperiods from the "Selecting, Subsetting & Indexing" section.
`r unhide()`
